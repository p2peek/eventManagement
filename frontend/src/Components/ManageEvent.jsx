...
//   try {
//     await axios.patch(`/api/events/assign-coordinators/${eventId}`, {
//       coordinatorId,
//     }, {
//       headers: {
//         Authorization: `Bearer ${localStorage.getItem("token")}`,
...
//                 <td className="py-2 px-4">{ev.venue}</td>
...
//                     defaultValue=""
//                     className="mt-2 block border border-gray-300 rounded-md px-2 py-1"
//                   >
...
//       );
//       alert("Coordinator assigned successfully");
//       fetchEvents(); // refresh to show updates
//     } catch (err) {
//       console.error("Failed to assign coordinator", err);
//     }
//   };
...
//                         return <li key={coordId}>{coord ? coord.name : "Unknown"}</li>;
//                       })
//                     ) : (
