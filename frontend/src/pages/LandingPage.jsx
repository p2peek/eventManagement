  ...
  return (
    <div className="w-full min-h-screen flex flex-col bg-white">
      ...
      <section className="flex flex-col justify-center items-center text-center w-full px-4 sm:px-8 min-h-screen bg-blue-50">
        ...
        <Link
          to="/register"
          // className="inline-block bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold px-8 py-3 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-transform duration-300 text-lg"
          // className="inline-block bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold px-8 py-3 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-transform duration-300 text-lg"
          className="inline-block bg-gradient-to-r from-blue-200 to-indigo-200 text-black font-semibold px-8 py-3 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-transform duration-300 text-lg"
        >
          Get Started
        </Link>
      </section>
